...
void instructions()
{
	 ...
	 printf("\nREVERSI\n\n");
     printf("Plyer 1 will be black so he/she will go first.\n");
     printf("Player 2 will be white and will start second and game will continue accordingly.\n");
     printf("Select a square for your move by typing a digit for the row\n "
    "and press enter and enter a digit for a column.\n");
     printf("\nWishing both players all the very best !  Press 1 to start and 0 to exit.\n");
